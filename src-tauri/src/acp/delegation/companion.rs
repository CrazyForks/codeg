...
impl CompanionFeatures {
    ...
    pub fn allows_tool(&self, name: &str) -> bool {
        match name {
            ...
            | "loop_report_blocked" | "loop_task_complete" | "loop_record_memory"
            | "loop_read_memory" | "loop_submit_reflection" => self.loop_tools,
            _ => false,
        }
    }
}
...
async fn build_tools_call_spawn(
    ...
    match name.as_str() {
        ...
        "loop_submit_route" | "loop_submit_artifacts" | "loop_submit_review"
        | "loop_report_blocked" | "loop_task_complete" | "loop_record_memory"
        | "loop_read_memory" | "loop_submit_reflection" => {
